...
- Development utilities
  ...
  - Code linting/formatting: [Oxlint](https://oxc.rs/docs/guide/usage/linter.html), [Oxfmt](https://oxc.rs/docs/guide/usage/formatter.html)
...
- Oxlint enforces certain style and correctness rules to help avoid common coding pitfalls and maintain consistency.
  ...
  - Correctness and established project rules use `error`. Newly enabled React performance and compiler checks use
    `warn` while the existing findings are worked down; CI's warning budget prevents the baseline from growing.
